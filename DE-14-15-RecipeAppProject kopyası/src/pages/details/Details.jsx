...
const Details = () => {
  ...
  //! RecipeCard da ki state:recipe1 verilerinin burada useLocation ile karsiliyoruz.
  //! useLocation= useNavigate in kardsidir, navigate in state ine yüklenen veriyi navigate in yönlendirdigi sayfada karsilar
